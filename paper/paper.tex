...
\paragraph{Enumerative program synthesis.} Bottom-up enumeration with
observational-equivalence pruning is a core technique in program
synthesis — TRANSIT~\cite{udupa2013}, recursive synthesis with
equivalence reduction~\cite{albarghouthi2013}, and the enumerative
solvers of the SyGuS competition~\cite{alur2013}. Our contribution is
not the enumeration schema but (i) the \emph{measurement} that a
