...
This work was produced in an AI-assisted research workflow: the
algorithm design, implementation, experiments, and manuscript
drafting were carried out with substantial use of a large language
model agent (Anthropic Claude), directed, reviewed, and validated by
the human author, who takes full responsibility for all claims. Every
